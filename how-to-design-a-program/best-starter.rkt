...
;; cityName -> boolean
;;the function takes city name and decide weather the city is the best in the world or notz
;;(define(city-name CN) false)
(check-expect(city-name "addis abeba") true)
(check-expect(city-name "dire dawa") false)

;;(define(city-name CN) string)

(define(city-name CN)
  (cond [(string=? CN "addis abeba") true]
       [else false]                           
